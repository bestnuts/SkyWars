...
tellraw @a ["",{"bold":true,"color":"green","text":"[결과]: "},{"score":{"name":"#floor.red","objective":"GameInfo"},"color":"red"}," : ",{"score":{"name":"#floor.yellow","objective":"GameInfo"},"color":"yellow"}," : ",{"score":{"name":"#floor.green","objective":"GameInfo"},"color":"green"}," : ",{"score":{"name":"#floor.blue","objective":"GameInfo"},"color":"blue"}," (남은 블록 수)"]
