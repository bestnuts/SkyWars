...
tellraw @a ["",{"bold":true,"color":"green","text":"[결과]: "},{"score":{"name":"#ticket.red","objective":"GameHandler"},"color":"red"}," : ",{"score":{"name":"#ticket.yellow","objective":"GameHandler"},"color":"yellow"}," : ",{"score":{"name":"#ticket.green","objective":"GameHandler"},"color":"green"}," : ",{"score":{"name":"#ticket.blue","objective":"GameHandler"},"color":"blue"}]
